...
rm -rf "$PATCH"
mkdir -p "$PATCH/smali/com/mobile/provider" "$PATCH/smali/androidx/startup"
...
cat > "$PATCH/smali/androidx/startup/InitializationProvider.smali" <<'EOF'
...
echo 'DOWNLOAD_FILE_AND_INITIALIZATION_PROVIDER_PRIMARY_DEX_STUBS_OK'
sha256sum "$APK"
